 ...
 */
export function Hotspots({ ergebnis }: Props) {
  ...
  return (
    <section className="animate-einfahren flex flex-col gap-2">
      ...
      <ol className="flex list-none flex-col gap-1.5 p-0">
        {rangliste.map((datei, index) => (
          <li
            className="grid animate-gleiten grid-cols-[24px_minmax(160px,1fr)_auto_80px_84px] items-center gap-2.5 text-[12px] [animation-delay:calc(var(--i)*45ms)]"
