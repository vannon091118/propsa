 ...
 *
 * Oben links: Logo, Produktname und der Update-Bereich (farbcodierter
 * Kreis + anklickbare Versionsnummer mit Notiz-Popup). Die ganze Leiste
 * ist Drag-Region; die Bedienelemente sind von der Drag-Region ausgenommen,
 * da sie eigene Klick-Handler haben.
 */
  ...
  return (
    ...
    >
      <div className="flex items-center gap-2">
        <svg
          className="pointer-events-none text-neon-cyan"
